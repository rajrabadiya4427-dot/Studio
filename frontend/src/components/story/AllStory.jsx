import { Menu, Plus, BookText } from 'lucide-react'
...
const AllStory = () => {
    ...
    const categories = [
        ...
        "Drama", "Comedy", "Historical", "Young Adult"
    ];
            ...
            <div className='relative flex h-full w-full items-top justify-center'>
                <div className="relative right h-full w-full flex flex-col items-center justify-between bg-black">
                    ...
                    <div className="w-full flex items-center justify-between px-5 border-b border-gray-500 py-4">
                        ...
                        <h1 className='font-bold text-lg text-white'>PUBLISHED STORIES</h1>

                        <button
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-full font-bold text-sm tracking-wide hover:opacity-90 hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-yellow-900/40"
                    ...
                    {isLoading ? (
                        ...
                        <div className="products-empty">
                            <BookText size={64} className="empty-icon" />
                            <h3>No Stories Published Yet</h3>
                            <p>Be the first to publish a story!</p>
                            <button
                                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-full font-bold text-sm tracking-wide hover:opacity-90 hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-yellow-900/40"
                                onClick={() => setIsModalOpen(true)}
                            >
                                <Plus size={18} /> Publish First Story
                            </button>
                        </div>
                    ) : (
